      ...
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            ...
            <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">Shopie</span></h4>
            ...
            <form method="POST" action="<?= base_url('login') ?>" class="needs-validation" novalidate="">
              <div class="form-group">
                ...
                <input id="email" type="email" class="form-control" value="<?= set_value('email'); ?>" autocomplete="FALSE" name="email" tabindex="1" required autofocus>
            ...
            <div class="text-center mt-5 text-small">
              Copyright&copy; Ferdi Ardian. Template Made with 💙 by Stisla
              <div class="mt-2">
